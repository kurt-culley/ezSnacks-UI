          ...
          <div className="media">
            <div className="media-body">
                <div className="media-heading">
                    <h4>{order_item.menu_item.name} <small>{order_item.menu_item.description}</small></h4>
                </div>
              <div className="row">
                ...
                <div className="col-xs-7">
                  <div className="row">
                    ...
                    <div className="col-xs-4 order-btn-div">
                      <button onClick={() => this.handleDeleteClick(order_item.id)} className="btn btn-danger order-item-quantity-btn">
